# LiveBG
A Wayland biased project that allows for the simple creation of a custom, interactive background for your Linux system.
## Features
* Window generation
* Rendering and ticking loop
* Keyboard input handling
* Multiple draw functions
* Fullscreen and windowed borderless toggle: ``F11``
* Exit keybind: ``Esc``
* Various utility functions
* Documentation!!!!!!
## Installation
### Automatic:
_An automatic script will be made soon to simplify installation_
### Manual:
